        ...
        <section>
            <div class="container">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <p>Welcome to Soft Minion. Before getting started, we need some information on the database. You will need to know the following items before proceeding.</p>
                        <ol>
                            <li>Database name</li>
                        ...
                        <br>
                        <a href="credentials.php" class="btn btn-primary">Let's Go</a>
                    </div>
                </div>
            </div>
        </section>
