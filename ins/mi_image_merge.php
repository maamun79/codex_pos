...
function mi_image_marge($images_path = array(), $output_image_path, $output_image_name, $output_image_extension, $output_text = array()){
    ...
    if (!is_array($images_path)){
        ...
        $path_replace = MI_BASE_URL.str_replace(dirname(__DIR__).DIRECTORY_SEPARATOR.'view/', '', $path);
